"""
Training script for the Swin V2 model.
"""
...
if run_env == "local":
    ...
    param_file_name = "swin_params.pth"
    result_file = "swin_results.npy"
    batch_size = 8
    param_path = ""
    epochs = 50
    learn_rate = 1e-5
...
# import data
img_transforms = modelling_utils.swin_transforms
